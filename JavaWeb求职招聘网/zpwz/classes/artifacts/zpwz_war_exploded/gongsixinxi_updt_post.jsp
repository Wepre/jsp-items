...
String sql="update gongsixinxi set gongsibianhao='"+gongsibianhao+"',gongsimingcheng='"+gongsimingcheng+"',fuzeren='"+fuzeren+"',dianhua='"+dianhua+"',dizhi='"+dizhi+"',leibie='"+leibie+"',zhucezijin='"+zhucezijin+"',gongsiguimo='"+gongsiguimo+"',mima='"+mima+"',youxiang='"+youxiang+"',jianjie='"+jianjie+"' where id= "+id;
connDbBean.executeUpdate(sql);
out.print("<script>alert('ÐÞ¸Ä³É¹¦!!');location.href='gongsixinxi_updt.jsp?id="+id+"';</script>");
%>
  </body>
</html>
