...
function check()
{
  ...
  String id=request.getParameter("id");
   %>
  <form name="form1" id="form1" method="post" action="gongsixinxi_updt_post.jsp?id=<%=id %>">
  修改公司信息:
  <br><br>
  <%
