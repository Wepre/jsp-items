...
function check()
{
  ...
  String id=request.getParameter("id");
   %>
  <form name="form1" id="form1" method="post" action="yingpinjilu_updt_post.jsp?id=<%=id %>">
  修改应聘记录:
  <br><br>
  <%
