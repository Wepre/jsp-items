...
response.addHeader("Content-Disposition", "attachment;filename=yingpinjilu.xls");
%>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor='#CCFFFF'>公司编号</td><td bgcolor='#CCFFFF'>公司名称</td><td bgcolor='#CCFFFF'>岗位名称</td><td bgcolor='#CCFFFF'>薪资待遇</td><td bgcolor='#CCFFFF'>应聘人</td><td bgcolor='#CCFFFF'>公司回复</td><td bgcolor='#CCFFFF' width='80' align='center'>是否审核</td>
  ...
  <%
   ...
   sql="";
  sql="select * from yingpinjilu  order by id desc";
