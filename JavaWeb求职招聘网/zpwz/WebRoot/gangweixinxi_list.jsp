...
%>
  ...
  <form name="form1" id="form1" method="post" action="">
   ...
   <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit2" value="导出EXCEL" style='border:solid 1px #000000; color:#666666' onClick="javascript:location.href='gangweixinxi_listxls.jsp';" />
</form>
...
%>
  <tr>
    ...
    <td width="90" align="center"><a href="gangweixinxi_updt.jsp?id=<%=id%>">修改</a>  <a href="del.jsp?id=<%=id %>&tablename=gangweixinxi" onClick="return confirm('真的要删除？')">删除</a> <a href="gangweixinxidetail.jsp?id=<%=id%>" target="_blank">详细</a></td>
  </tr>
  	<%
  }
   %>
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="gangweixinxi_list.jsp?page=1">首页</a>　<a href="gangweixinxi_list.jsp?page=<%= curpage-1%>">上一页</a>　<A href="gangweixinxi_list.jsp?page=<%= curpage+1%>">下一页</A>　<a href="gangweixinxi_list.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>
  </body>
</html>
