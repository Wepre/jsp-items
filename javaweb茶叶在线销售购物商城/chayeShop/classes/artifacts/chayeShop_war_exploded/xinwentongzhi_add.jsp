...
function check()
{
  ...
  <body >
 <form  action="xinwentongzhi_add.jsp?f=f&lb=<%=lb%>"  method="post" name="f1"  onsubmit="return checkform();">
  添加新闻数据:
  <br><br>
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
	...
	<tr>
      <td>摘要：</td>
	  <td><textarea name="zhaiyao" cols="60" rows="4" id="zhaiyao"></textarea></td>
     </tr>
