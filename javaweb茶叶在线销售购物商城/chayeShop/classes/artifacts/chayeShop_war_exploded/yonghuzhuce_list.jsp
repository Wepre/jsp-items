...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  ...
  <tr>
    ...
    <td width="71" align="center"><a href="yonghuzhuce_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="yonghuzhuce_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a></td>
  </tr>
  	<%
