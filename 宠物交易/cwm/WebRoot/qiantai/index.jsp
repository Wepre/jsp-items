...
<html>
  ...
  <BODY text=#000000  leftMargin=0 topMargin=0>
	<div class="wrap"> 
		<TABLE  cellSpacing=0 cellPadding=0   align=center border=0  style="height:235px;width:900px;background-repeat:no-repeat"  background="<%=path %>/img/reservation01.gif">
				<TR height="90">
					<TD align="center">
				...
				<TR>
					...
					<TD class=Side vAlign=top align=right width="87%">
						<TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
								<TR>
									<TD class=head>
										<span style="float:left">销售排行榜</span>
							            <span style="float:right">&nbsp;&nbsp;&nbsp;&nbsp;</span>
									</TD>
								</TR>
								<TR align="left" height="160">
									<TD>
									      <table cellspacing="8" cellpadding="1" align="center" border="0">
									          <tr>
									               <c:forEach items="${requestScope.paihangList}" var="goods" varStatus="sta">
									                  ...
									                  <td align="center">
														   <a href="<%=path %>/goods?type=goodsDetailQian&id=${goods.id }">  
														      <img width="160" height="110" src="<%=path %>${goods.fujian }" style="border:1px solid #ccc; padding:3px;"/>
														   </a>
														   <br>
									                       ${goods.mingcheng }
									                       (￥:${goods.shichangjia }元)
